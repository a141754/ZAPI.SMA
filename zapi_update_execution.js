...
//passing issueId and projectId to URI from command line, e.g.: node get_executes.js 164429 23100
 console.log("\x1b[34m", 'passing executionId and projectId to URI from command line, e.g.: node zapi_get_executions.js 164429 23100');
...
//To Create API Specific JWT Token.
  var METHOD = 'GET'
  var API_URI = `https://prod-api.zephyr4jiracloud.com/connect/public/rest/api/1.0/executionId/${myArgs[0]}`
  var JWT_EXPIRE = 72000
  
  var token = JwtClient.generateJWT(METHOD, API_URI, JWT_EXPIRE);
  var request_body = {"status":{"id":1}};
