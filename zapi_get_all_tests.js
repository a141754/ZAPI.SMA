...
//passing issueId and projectId to URI from command line, e.g.: node zapi_get_all_tests.js 164429 23100
...
//To Create API Specific JWT Token.
  var METHOD = 'GET'
  var API_URI = `https://prod-api.zephyr4jiracloud.com/connect/public/rest/api/1.0/teststep/${myArgs[0]}?projectId=${myArgs[1]}`
